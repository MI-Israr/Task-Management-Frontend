  ...
  return (
    <div className="flex items-center gap-3 p-3">
      <input
        ...
        onChange={onChange}
        className="w-4 h-4 text-primary bg-gray-100 border-gray-100 rounded-sm outline-none cursor-pointer"
      />
...
const Attachments = ({ link, index, onClick }) => {
  return (
    <div
      className="flex justify-between items-center bg-gray-50 border border-gray-100 px-3 py-2 rounded-md mb-3 mt-2 cursor-pointer"
      onClick={onClick}
    >
